...
#### 2. Logging Standard ([logging-patterns.md](../../../references/logging-patterns.md))
...
#### 3. Environment Variables ([environment-variables.md](../../../references/environment-variables.md))
...
#### 4. Type Safety ([dry-rb-patterns.md](../../../references/dry-rb-patterns.md))
...
#### 5. Debugging Console ([pry-console.md](../../../references/pry-console.md))
...
#### 6. Project Structure ([rubysmith-scaffolding.md](../../../references/rubysmith-scaffolding.md))
